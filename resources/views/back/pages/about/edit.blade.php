                                ...
                                <div class="tab-content p-3 text-muted">
                                    ...
                                    <div class="tab-pane active" id="az" role="tabpanel">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="hidden" name="description_az" id="description_az" value="{{ old('description_az', $about->description_az) }}">
                                            <div id="editorAZ" class="ck-content">{!! old('description_az', $about->description_az) !!}</div>
                                        </div>
                                    </div>
                                        <div class="mb-3">
                                    ...
                                    <div class="tab-pane" id="en" role="tabpanel">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="hidden" name="description_en" id="description_en" value="{{ old('description_en', $about->description_en) }}">
                                            <div id="editorEN" class="ck-content">{!! old('description_en', $about->description_en) !!}</div>
                                        </div>
                                        <div class="mb-3">
                                    ...
                                    <div class="tab-pane" id="ru" role="tabpanel">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="hidden" name="description_ru" id="description_ru" value="{{ old('description_ru', $about->description_ru) }}">
                                            <div id="editorRU" class="ck-content">{!! old('description_ru', $about->description_ru) !!}</div>
                                        </div>
                                        <div class="mb-3">
