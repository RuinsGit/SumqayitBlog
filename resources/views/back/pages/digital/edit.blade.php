                                ...
                                <div class="row mb-4">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            @if($digital->image_az)
                                                <div class="mt-2">
                                                    <img src="{{ asset('storage/' . $digital->image_az) }}" alt="" class="img-fluid" style="max-height: 100px">
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            @if($digital->image_en)
                                                <div class="mt-2">
                                                    <img src="{{ asset('storage/' . $digital->image_en) }}" alt="" class="img-fluid" style="max-height: 100px">
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            @if($digital->image_ru)
                                                <div class="mt-2">
                                                    <img src="{{ asset('storage/' . $digital->image_ru) }}" alt="" class="img-fluid" style="max-height: 100px">
                                                </div>
                                            @endif
                                        </div>
                                    </div>
