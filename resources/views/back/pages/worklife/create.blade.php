        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Yeni Worklife Əlavə Et</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('back.pages.worklife.store') }}" method="POST" class="needs-validation" novalidate>
                                @csrf
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade show active" id="az" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="hidden" name="description_az" id="description_az">
                                            <div id="editorAZ" class="ck-content"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="en" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <div id="editorEN" class="ck-content"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="ru" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <div id="editorRU" class="ck-content"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4">
                                    <button type="submit" class="btn btn-primary me-2">
                                        <i class="fas fa-save me-2"></i>Əlavə Et
                                    </button>
