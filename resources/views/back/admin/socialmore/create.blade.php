...
@section('title', 'Yeni Sosial Projects')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Yeni Sosial Projects</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('back.pages.socialmore.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
